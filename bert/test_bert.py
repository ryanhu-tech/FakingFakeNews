...
parser.add_argument('--model_name', default='bert-base-uncased')#roberta-large
...
test_set = PropaFakeDataset(os.path.join(args.data_dir,'snopes_test.jsonl'), tokenizer)
